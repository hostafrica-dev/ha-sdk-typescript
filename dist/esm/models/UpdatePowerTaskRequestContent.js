 ...
 */
export function instanceOfUpdatePowerTaskRequestContent(value) {
...
export function UpdatePowerTaskRequestContentFromJSON(json) {
    return UpdatePowerTaskRequestContentFromJSONTyped(json, false);
}
export function UpdatePowerTaskRequestContentFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function UpdatePowerTaskRequestContentToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
