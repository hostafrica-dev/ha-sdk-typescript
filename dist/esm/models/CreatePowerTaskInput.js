 ...
 */
export function instanceOfCreatePowerTaskInput(value) {
...
export function CreatePowerTaskInputFromJSON(json) {
    return CreatePowerTaskInputFromJSONTyped(json, false);
}
export function CreatePowerTaskInputFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function CreatePowerTaskInputToJSON(json) {
    return CreatePowerTaskInputToJSONTyped(json, false);
}
export function CreatePowerTaskInputToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
