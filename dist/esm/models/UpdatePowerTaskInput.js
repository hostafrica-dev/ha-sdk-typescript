 ...
 */
export function instanceOfUpdatePowerTaskInput(value) {
...
export function UpdatePowerTaskInputFromJSON(json) {
    return UpdatePowerTaskInputFromJSONTyped(json, false);
}
export function UpdatePowerTaskInputFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function UpdatePowerTaskInputToJSON(json) {
    return UpdatePowerTaskInputToJSONTyped(json, false);
}
export function UpdatePowerTaskInputToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
