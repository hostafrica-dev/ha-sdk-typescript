...
exports.instanceOfUpdateNotificationRequestContent = instanceOfUpdateNotificationRequestContent;
exports.UpdateNotificationRequestContentFromJSON = UpdateNotificationRequestContentFromJSON;
 ...
 */
function instanceOfUpdateNotificationRequestContent(value) {
...
function UpdateNotificationRequestContentFromJSON(json) {
    return UpdateNotificationRequestContentFromJSONTyped(json, false);
}
function UpdateNotificationRequestContentFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
function UpdateNotificationRequestContentToJSON(json) {
    return UpdateNotificationRequestContentToJSONTyped(json, false);
}
function UpdateNotificationRequestContentToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
